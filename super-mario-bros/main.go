...
func main() {
	...
	// NES resolution: 256×144. The LDtk world is wider (scrolling level);
	// the camera system handles the viewport offset.
	const virtualW, virtualH = 256, 144
	...
	// Window = 3× NES resolution for crisp display.
	ebiten.SetWindowSize(g.loaded.ScreenW*3, g.loaded.ScreenH*3)
