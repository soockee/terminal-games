...
// NewPhysicsSpace creates the singleton physics space with the given downward
// gravity (pixels/s²).
func NewPhysicsSpace(w donburi.World, gravity float64) *physics.Space {
	space := physics.New(gravity)
